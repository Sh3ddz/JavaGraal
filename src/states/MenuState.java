...
public class MenuState extends State
{
	...
	public MenuState(Handler handler)
	{
		...
		this.player = new Player(handler, world.getSpawnX(), world.getSpawnY());
	...
	public void mainMenu(Graphics g)
	{
	    ...
	    g.setColor(Color.BLACK);  
	    g.drawString("EXIT GRAAL", 255, 325);
	...
	public void controlsMenu(Graphics g)
	{
	    ...
	    g.drawString("SpaceBar", 105, 110);
	    g.drawString("F3", 165, 135);

		g.setColor(Color.YELLOW);
	    g.drawString("| Move your character", 200, 60);
	    g.drawString("| Open / Close Menu", 200, 85);
	    g.drawString("| Swing your sword", 200, 110);
	    g.drawString("| Open Dev View", 200, 135);
