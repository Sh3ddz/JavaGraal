...
public class Tile 
{
	//STATIC STUFF HERE
		...
		public static Tile tallGrass1Tile = new TallGrassTile(Assets.tallgrass1, 27);
		public static Tile tallGrass2Tile = new TallGrassTile(Assets.tallgrass2, 28);
		public static Tile tallGrass3Tile = new TallGrassTile(Assets.tallgrass3, 29);
		public static Tile tallGrass4Tile = new TallGrassTile(Assets.tallgrass4, 30);
		...
		public static Tile tallgrassend1Tile = new TallGrassTile(Assets.tallgrassend1, 130);
		public static Tile tallgrassend2Tile = new TallGrassTile(Assets.tallgrassend2, 131);
		public static Tile tallgrassend3Tile = new TallGrassTile(Assets.tallgrassend3, 132);
		public static Tile tallgrassend4Tile = new TallGrassTile(Assets.tallgrassend4, 133);
